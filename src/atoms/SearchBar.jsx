...
const SearchBar = () => {
  ...
  return (
    <form className='flex items-center gap-2 self-center'>
        <input type="text" placeholder='search for your favorite' className={`p-2   rounded-2xl outline-none ${darkTheme ? "bg-white text-black" : "bg-black text-white"}`} name='text' />
